...
export const JUNE_2026_EXPENSES: SeedExpense[] = [
  ...
  { date: '2026-06-17', vendor: 'Lyft', amount: 11.96, categoryName: 'Travel & Rides', description: 'Work travel', isTaxDeductible: true, importKey: 'expensify:2026-06-17:lyft:11.96' },
  {
    ...
    notes: 'Mileage log for vehicle business-use % — not a second dollar deduction on top of gas',
  },
]
...
export const JUNE_2026_INCOME: SeedIncome[] = [
  {
    date: '2026-06-06',
    amount: 1350.45,
    description: 'Invoice #001 — Stage subcontract',
    client: 'Stage',
  ...
  },
  {
    date: '2026-06-12',
    amount: 1262.25,
    description: 'Invoice #002 — Stage subcontract',
    client: 'Stage',
    incomeSource: 'subcontractor',
  ...
  },
  {
    date: '2026-06-19',
    amount: 1185.75,
    description: 'Invoice #003 — Stage subcontract',
    client: 'Stage',
    incomeSource: 'subcontractor',
